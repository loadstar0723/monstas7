...
// 동적 임포트로 성능 최적화
const HFTPatternModule = dynamic(
  () => import('./HFTPatternModule'),
  { 
    loading: () => (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-purple-500 mx-auto mb-4"></div>
          <p className="text-gray-400">HFT 패턴 분석 모듈 로딩 중...</p>
        </div>
      </div>
    ),
    ssr: false 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center p-4">
      <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-8 max-w-lg w-full">
        ...
        <p className="text-gray-300 mb-2">HFT 패턴 분석 모듈을 로드하는 중 문제가 발생했습니다.</p>
