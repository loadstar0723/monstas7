...
const FibonacciModule = dynamic(
  () => import('./FibonacciModule').catch((err) => {
    console.error('Failed to load FibonacciModule:', err)
    // 에러 발생 시 폴백 컴포넌트 반환
    return {
      default: () => (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-400">피보나치 분석 모듈을 불러오는 중 오류가 발생했습니다.</p>
            <button 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">피보나치 분석 준비 중...</h2>
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Fibonacci Page Error:', error, errorInfo)
  }
