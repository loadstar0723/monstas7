...
const ARIMAModule = dynamic(
  () => import('./ARIMAModule').catch((err) => {
    console.error('Failed to load ARIMAModule:', err)
    return {
      default: () => (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
          <div className="text-center">
            <FaChartBar className="text-6xl text-red-500 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-white mb-2">모듈 로드 실패</h2>
            <p className="text-gray-400">ARIMA 모듈을 불러오는 중 오류가 발생했습니다.</p>
            <button 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">ARIMA 통계 모델 준비 중...</h2>
        <p className="text-gray-400">시계열 분석 엔진을 불러오고 있습니다</p>
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('ARIMA Page Error:', error, errorInfo)
  }
      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-red-500/50">
            <div className="text-center">
              <FaChartBar className="text-5xl text-red-500 mx-auto mb-4" />
