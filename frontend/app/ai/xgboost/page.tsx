...
const XGBoostModule = dynamic(
  () => import('./XGBoostModule').catch((err) => {
    console.error('Failed to load XGBoostModule:', err)
    return {
      default: () => (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-400">XGBoost 모듈을 불러오는 중 오류가 발생했습니다.</p>
            <button 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">XGBoost 모델 준비 중...</h2>
        <p className="text-gray-400">그래디언트 부스팅 엔진을 불러오고 있습니다</p>
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('XGBoost Page Error:', error, errorInfo)
  }
