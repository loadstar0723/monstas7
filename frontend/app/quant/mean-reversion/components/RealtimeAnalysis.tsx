      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        >
          ...
          <div className={`text-2xl font-bold ${
            ...
            {marketData.zScore?.toFixed(2) || '0.00'}
          </div>
        ...
        >
          ...
          <div className={`text-2xl font-bold ${
            ...
            {priceFromSMA20 >= 0 ? '+' : ''}{priceFromSMA20?.toFixed(2) || '0.00'}%
          </div>
          <div className="text-xs text-gray-500 mt-1">
            SMA: ${marketData.sma20?.toFixed(2) || '0'}
          </div>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-lg p-4 border border-blue-700/30">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-white font-bold">${marketData.sma20?.toFixed(2) || '0'}</span>
          </div>
        ...
        <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-lg p-4 border border-purple-700/30">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-white font-bold">${marketData.sma50?.toFixed(2) || '0'}</span>
          </div>
          <div className="w-full bg-gray-700 rounded-full h-2">
            <div 
        ...
        <div className="bg-gradient-to-r from-orange-900/20 to-orange-800/20 rounded-lg p-4 border border-orange-700/30">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-white font-bold">${marketData.sma200?.toFixed(2) || '0'}</span>
          </div>
          <div className="w-full bg-gray-700 rounded-full h-2">
            <div 
      ...
      <div className="bg-black/30 rounded-lg p-4 border border-gray-700">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-red-300">${marketData.upperBand?.toFixed(2) || '0'}</span>
            <span className="text-red-400">+{priceFromUpperBand?.toFixed(2) || '0.00'}%</span>
          </div>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-green-300">${marketData.lowerBand?.toFixed(2) || '0'}</span>
            <span className="text-green-400">-{priceFromLowerBand?.toFixed(2) || '0.00'}%</span>
          </div>
        </div>
      </div>
    </motion.div>
