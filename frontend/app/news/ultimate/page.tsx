      ...
      >
        <div className="p-6">
              ...
              {news.tradingSignal && (
                <div className="flex items-center gap-2 mt-2">
                  <span className={`px-3 py-1 rounded-lg font-bold ${
                    ...
                    {news.tradingSignal.direction === 'long' ? '?“ˆ ë§¤ìˆ˜' :
                     news.tradingSignal.direction === 'short' ? '?“‰ ë§¤ë„' : '?¡ï¸ ì¤‘ë¦½'}
                  </span>
                  <span className="text-gray-400">
                    ? ë¢°?? <span className="text-white font-bold">{news.tradingSignal.confidence}%</span>
                  </span>
                </div>
              )}
            </div>
          ...
          <div className="flex flex-wrap gap-4 mb-6 text-sm">
            ...
            {news.author && <span className="text-gray-400">?ï¸ {news.author}</span>}
          </div>
          ...
          <div className="mb-4">
            ...
            >
              {translating ? 'ë²ˆì—­ ì¤?..' : showTranslation ? '?ë¬¸ ë³´ê¸°' : '?Œ ?œêµ­?´ë¡œ ë²ˆì—­'}
            </button>
          </div>
          ...
          {news.tradingSignal && news.currentPrice && (
            <div className="mb-6">
              <h3 className="text-lg font-bold text-white mb-3">?“Š AI ?¸ë ˆ?´ë”© ë¶„ì„</h3>
          ...
          {news.relatedCoins.length > 0 && (
            <div className="mb-6">
              <h3 className="text-sm text-gray-500 mb-2">ê´€??ì½”ì¸</h3>
...
export default function UltimateCryptoNewsPortal() {
  ...
  const categories = [
    { id: 'all', name: '?„ì²´', icon: '?“°', color: 'purple' },
    { id: 'breaking', name: '?ë³´', icon: '?š¨', color: 'red' },
    { id: 'regulatory', name: 'ê·œì œ', icon: '?–ï¸', color: 'blue' },
    { id: 'defi', name: 'DeFi', icon: '?”·', color: 'green' },
    { id: 'technical', name: 'ê¸°ìˆ ', icon: '?“Š', color: 'indigo' },
    { id: 'market', name: '?œì¥', icon: '?“ˆ', color: 'cyan' },
    { id: 'security', name: 'ë³´ì•ˆ', icon: '?”', color: 'orange' },
    { id: 'exchange', name: 'ê±°ë˜??, icon: '?¦', color: 'yellow' }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            AI ?¸ë ˆ?´ë”© ?œê·¸?????¤ì‹œê°?ë²ˆì—­ ???Œì…œ ?¼í‹°ë¨¼íŠ¸ ??{allNews.length}ê°œì˜ ìµœì‹  ?´ìŠ¤
          </p>
        </motion.div>
        ...
        {marketSentiment && (
          ...
          >
            <h2 className="text-xl font-bold text-white mb-4">?“Š ?œì¥ ?¼í‹°ë¨¼íŠ¸ ë¶„ì„</h2>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400">{marketSentiment.bullish.toFixed(1)}%</div>
                <div className="text-sm text-gray-400">?“ˆ ê°•ì„¸</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-400">?¡ï¸ ì¤‘ë¦½</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm text-gray-400">?˜± ê³µí¬/?ìš•</div>
        ...
        {/* ì½”ì¸ ? íƒ ë²„íŠ¼ */}
        <div className="mb-6">
          <h3 className="text-sm text-gray-400 mb-3">ì½”ì¸ë³??´ìŠ¤ ?„í„°</h3>
          <div className="flex flex-wrap gap-2">
            {coins.map(coin => (
              <motion.button
                key={coin}
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* ë³´ê¸° ëª¨ë“œ & ?ë™ ë²ˆì—­ */}
          <div>
            <label className="text-sm text-gray-400 mb-2 block">?¤ì •</label>
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mt-4">AI ë¶„ì„ ë°??¤ì‹œê°??°ì´??ë¡œë”© ì¤?..</p>
          </div>
        )}
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        {news.isTranslated && (
                          <span className="text-xs text-green-400">?Œ ë²ˆì—­??/span>
                        )}
                      </div>
                      {news.image && (
                        <img
        ...
        {!loading && filteredNews.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 text-lg">? íƒ??ì¡°ê±´??ë§ëŠ” ?´ìŠ¤ê°€ ?†ìŠµ?ˆë‹¤.</p>
          </div>
        )}
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>?¤– AI ?¸ë ˆ?´ë”© ?œê·¸?????Œ Claude API ë²ˆì—­ ???“Š ?¤ì‹œê°??¼í‹°ë¨¼íŠ¸ ë¶„ì„</p>
          <p className="mt-2">?°ì´???œê³µ: CryptoCompare, Binance, Coinbase</p>
        </div>
      </div>
    </div>
  )
